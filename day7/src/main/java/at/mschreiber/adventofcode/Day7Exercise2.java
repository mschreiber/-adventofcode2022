...
public class Day7Exercise2 {
  ...
  public static void main(String[] args) {
    ...
    Dir toDelete = root;
    findDirToDelete(root, toDelete, neededSpace);
  }

  public static void findDirToDelete(Dir dir, Dir currentDirToDelete, int neededSpace) {
    if (dir.size >= neededSpace && dir.size < currentDirToDelete.size) {
      currentDirToDelete = dir;
      System.out.println(currentDirToDelete.size);
    }
    for (FsEntry fsEntry : dir.files) {
      if (fsEntry instanceof Dir) {
        findDirToDelete((Dir)fsEntry, currentDirToDelete, neededSpace);
      }
    }
  }
